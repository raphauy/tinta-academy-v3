...
export function DataTableToolbar<TData>({ table }: DataTableToolbarProps<TData>) {
  ...
  return (
    <div className="flex gap-1 dark:text-white items-center">
          ...
          <Input className="max-w-xs" placeholder="bio filter..."
              value={(table.getColumn("bio")?.getFilterValue() as string) ?? ""}
              onChange={(event) => table.getColumn("bio")?.setFilterValue(event.target.value)}                
          />
